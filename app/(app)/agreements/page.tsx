...
export default function AgreementsPage() {
  ...
  const statuses = isAdmin
    ? ["DRAFT", "SENT", "VIEWED", "CHANGES_REQUESTED", "REVISION_IN_PROGRESS", "AWAITING_APPROVAL", "AWAITING_SIGNATURE", "SIGNED", "DELIVERY_REVIEW", "COMPLETED", "REJECTED", "EXPIRED", "CANCELLED"]
    : ["SENT", "VIEWED", "CHANGES_REQUESTED", "REVISION_IN_PROGRESS", "AWAITING_APPROVAL", "AWAITING_SIGNATURE", "SIGNED", "DELIVERY_REVIEW", "COMPLETED", "REJECTED", "EXPIRED"];
